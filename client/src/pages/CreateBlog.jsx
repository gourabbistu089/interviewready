          ...
          <div className="p-8 space-y-8">
            ...
            <div>
              ...
              <div className="space-y-4">
                {!imagePreview ? (
                  <div
                    className={`border-2 border-dashed ${errors.featuredImage ? "border-red-300" : "border-gray-300"} rounded-xl p-8 text-center hover:border-blue-400 transition-colors`}
                  >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("readTime", parseInt(e.target.value) || 1)
                  }
                  min="1"
