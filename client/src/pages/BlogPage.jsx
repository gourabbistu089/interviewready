...
//     setLoading(true);
//     try {
//       const res = await axios.get(`${API_URL}/blogs?page=${page}&limit=10`);
//       if (res.data.success) {
...
//   // const articles = [/* your blogs array here */];
...
//   // const allArti/cles = [...featuredArticles, ...articles];
...
//     hasMore && (
//       <>
//                   <div  className='bg-green-700 w-full ' ref={loader} style={{ textAlign: 'center', padding: '20px' }}>
//         {loading ? '🔄 Loading more posts...' : '⬇️ Scroll down to load more'}
//       </div>
//       </>
//     )
//    }
...
// const InfiniteScrollLoader = ({ loading, hasMore, onLoadMore }) => {
...
//           </p>
//           <div className="flex items-center justify-center space-x-1 text-sm text-indigo-600">
...
//             <div className="absolute inset-0 rounded-full border-2 border-purple-200 animate-ping animation-delay-200"></div>
//           </div>
...
//           onClick={onLoadMore}
//         >
//           <div className="w-12 h-12 bg-white border-2 border-gray-200 rounded-full flex items-center justify-center shadow-md group-hover:shadow-lg group-hover:border-indigo-300 transition-all duration-300">
//             <ChevronDown className="h-6 w-6 text-gray-400 group-hover:text-indigo-500 transition-colors duration-300" />
//           </div>
